...
!(function (e, t) {
  ...
  function s (e) {
    return ((o (e) ? e.ownerDocument : e.document) ||
  ...
  function m (e, t) {
    ...
    var o = n (r);
    return (r = e
      ? [o].concat (o.visualViewport || [], p (r) ? r : [])
      : r), (t = t.concat (r)), e ? t : t.concat (m (d (r)));
  }
  function h (e) {
  ...
  function O (e, t) {
    ...
    if (
      ((r = o) &&
        (r = o instanceof (r = n (o).ShadowRoot) || o instanceof ShadowRoot), r)
    )
      do {
  ...
  function x (e, o) {
    if ('viewport' === o) {
      ...
      var l = 0, u = 0;
      o &&
        ((p = o.width), (a = o.height), /^((?!chrome|android).)*safari/i.test (
          navigator.userAgent
        ) || ((l = o.offsetLeft), (u = o.offsetTop))), (e = w (
        (e = {width: p, height: a, x: l + f (e), y: u})
      ));
  ...
  function j (e, t, n) {
    return (t = 'clippingParents' === t
      ...
      return (n = x (
        e,
        n
      )), (t.top = Math.max (n.top, t.top)), (t.right = Math.min (n.right, t.right)), (t.bottom = Math.min (n.bottom, t.bottom)), (t.left = Math.max (n.left, t.left)), t;
    }, x (e, n[0]))).width =
      n.right -
  ...
  function L (e, n) {
    ...
    (c =
      e.rects
        .popper), (a = j (o ((p = e.elements[p ? ('popper' === i ? 'reference' : 'popper') : i])) ? p : p.contextElement || s (e.elements.popper), a, f)), (p = E ({reference: (f = t (l)), element: c, strategy: 'absolute', placement: n})), (c = w (Object.assign (Object.assign ({}, c), p))), (f = 'popper' === i ? c : f);
    var u = {
        ...
        p = {
          ...
          setOptions: function (i) {
            return a (), (s.options = Object.assign (
              ...
              reference: o (e)
                ? m (e)
                : e.contextElement ? m (e.contextElement) : [],
              popper: m (t),
            }), (i = (function (e) {
              var t = v (e);
              ...
              (n = void 0 === n
                ? {}
                : n), 'function' == typeof (e = e.effect) && ((t = e ({state: s, name: t, instance: p, options: n})), f.push (t || function () {}));
            }), p.update ();
          },
              ...
              if (k (t, (e = e.popper)))
                for (
                  ...
                  if (!0 === s.reset) (s.reset = !1), (t = -1);
                    ...
                    e = n.fn;
                    var r = n.options;
                    (r = void 0 === r ? {} : r), (n = n.name), 'function' ==
                      typeof e &&
                      (s =
                        e ({state: s, options: r, name: n, instance: p}) || s);
                  }
            }
          },
          update: b (function () {
  ...
  function W (e) {
    ...
    if (p) {
      var b = g (r);
      b === n (r) && (b = s (r)), 'top' === i &&
        ((h = 'bottom'), (l -= b.clientHeight - o.height), (l *= c
          ? 1
          : -1)), 'left' === i &&
    ...
    return (r = Object.assign (
      {position: f},
      p && z
    )), c ? Object.assign (Object.assign ({}, r), {}, (((d = {})[h] = a ? '0' : ''), (d[m] = u ? '0' : ''), (d.transform = 2 > (v.devicePixelRatio || 1) ? 'translate(' + e + 'px, ' + l + 'px)' : 'translate3d(' + e + 'px, ' + l + 'px, 0)'), d)) : Object.assign (Object.assign ({}, r), {}, (((t = {})[h] = a ? l + 'px' : ''), (t[m] = u ? e + 'px' : ''), (t.transform = ''), t));
  }
  function A (e) {
    ...
    X = {
      ...
      fn: function (e) {
        ...
        Object.keys (t.elements).forEach (function (e) {
          ...
          i (o) &&
            a (o) &&
            (Object.assign (o.style, n), Object.keys (r).forEach (function (e) {
              var t = r[e];
              !1 === t
                ? o.removeAttribute (e)
      ...
      effect: function (e) {
        ...
        return Object.assign (t.elements.popper.style, n.popper), t.elements
          .arrow &&
          ...
          Object.keys (t.elements).forEach (function (e) {
            ...
            (e = Object.keys (
              ...
              a (r) &&
              (Object.assign (r.style, e), Object.keys (o).forEach (function (
                e
              ) {
                r.removeAttribute (e);
              }));
      ...
      fn: function (e) {
        var t = e.state,
          ...
          o = (e = C.reduce (function (e, n) {
            ...
            return (o =
              (o = s[0]) ||
              0), (s = ((s = s[1]) || 0) * a), (i = 0 <= ['left', 'right'].indexOf (i) ? {x: s, y: o} : {x: o, y: s}), (e[n] = i), e;
          }, {}))[t.placement],
          i = o.x;
        (o = o.y), null != t.modifiersData.popperOffsets &&
          ((t.modifiersData.popperOffsets.x += i), (t.modifiersData.popperOffsets.y += o)), (t.modifiersData[
          n
        ] = e);
      },
    },
      ...
      fn: function (e) {
        ...
        if (((e = e.name), !t.modifiersData[e]._skip)) {
          ...
          for (var h = d[0], g = 0; g < d.length; g++) {
            ...
            if (
              ((O = w ? (O ? 'right' : 'left') : O ? 'bottom' : 'top'), n[x] >
                i[x] && (O = A (O)), (x = A (O)), (w = []), r &&
                w.push (0 >= j[b]), o &&
                w.push (0 >= j[O], 0 >= j[x]), w.every (function (e) {
                return e;
              }))
            ) {
              (h = v), (p = !1);
        ...
        if (((s = {x: 0, y: 0}), l)) {
          if (o) {
            ...
            var w = l[p] + n[v],
              ...
              E = 'start' === f ? d[O] : m[O];
            (f = 'start' === f ? -m[O] : -d[O]), (m =
              t.elements.arrow), (m = i && m ? u (m) : {width: 0, height: 0});
            var D = t.modifiersData['arrow#persistent']
              ? t.modifiersData['arrow#persistent'].padding
              : {top: 0, right: 0, bottom: 0, left: 0};
            (v = D[v]), (b = D[b]), (m = Math.max (
              0,
              Math.min (d[O], m[O])
            )), (E = c ? d[O] / 2 - j - m - v - h : E - m - v - h), (c = c
              ? -d[O] / 2 + j + m + b + h
              : f + m + b + h), (h =
              t.elements.arrow && g (t.elements.arrow)), (d = t.modifiersData
              .offset
              ...
              d -
              (h
                ? 'y' === p ? h.clientTop || 0 : h.clientLeft || 0
                : 0)), (c = l[p] + c - d), (i = Math.max (
              i ? Math.min (w, h) : w,
          ...
          r &&
            ...
            )), (l[a] = i), (s[a] = i - r)), (t.modifiersData[e] = s);
        }
      },
      requiresIfExists: ['offset'],
    },
    Z = {
      ...
      fn: function (e) {
        ...
        var r = n.elements.arrow,
          ...
          a = M (i);
        if (
          ((i = 0 <= ['left', 'right'].indexOf (i) ? 'height' : 'width'), r &&
            o)
        ) {
          var s = n.modifiersData[e + '#persistent'].padding,
            ...
            l =
              ...
              o[a] -
              n.rects.popper[i];
          (o = o[a] - n.rects.reference[a]), (l =
            (r = (r = g (r))
              ? 'y' === a ? r.clientHeight || 0 : r.clientWidth || 0
              : 0) /
              2 -
            f[i] / 2 +
            (l / 2 - o / 2)), (i = Math.max (
            s[c],
            Math.min (l, r - f[i] - s[p])
          )), (n.modifiersData[e] = (((t = {})[a] = i), (t.centerOffset =
            i - l), t));
        }
      },
      effect: function (e) {
        ...
        var r = n.element;
        if (
          ((r = void 0 === r ? '[data-popper-arrow]' : r), (n = void 0 ===
            (n = n.padding)
            ? 0
            : n), null != r)
        ) {
          ...
          O (t.elements.popper, r) &&
            ((t.elements.arrow = r), (t.modifiersData[e + '#persistent'] = {
...
!(function (t, e) {
  ...
  function r (t, e) {
    ...
    (t.prototype = Object.create (
      e.prototype
    )), (t.prototype.constructor = t), (n = t), (i = e), (Object.setPrototypeOf ||
      function (t, e) {
  ...
  var a,
    ...
    T = function (t, e) {
      ...
      (n = function () {
        ...
        if (n) {
          var i = n.fn[t];
          (n.fn[t] = e.jQueryInterface), (n.fn[t].Constructor = e), (n.fn[
            t
          ].noConflict = function () {
    ...
    A = ((a = {}), (l = 1), {
      set: function (t, e, n) {
        void 0 === t.bsKey && ((t.bsKey = {key: e, id: l}), l++), (a[
          t.bsKey.id
        ] = n);
      },
      get: function (t, e) {
                ...
                return function i (o) {
                  for (
                    ...
                    for (var a = s.length; a--; )
                      if (s[a] === r)
                        return (o.delegateTarget = r), i.oneOff &&
                          K.off (t, o.type, n), n.apply (r, [o]);
                  return null;
                };
              }) (t, n, i)
            : (function (t, e) {
                return function n (i) {
                  return (i.delegateTarget = t), n.oneOff &&
                    K.off (t, i.type, e), e.apply (t, [i]);
                };
              }) (t, n);
        (f.delegationSelector = r
          ? n
          : null), (f.originalHandler = a), (f.oneOff = o), (f.uidEvent = d), (u[
          d
        ] = f), t.addEventListener (l, f, r);
      }
    }
  }
  ...
  var K = {
    ...
    trigger: function (t, e, n) {
      ...
      return r &&
        o &&
        ((i = o.Event (e, n)), o (t).trigger (
          i
        ), (l = !i.isPropagationStopped ()), (c = !i.isImmediatePropagationStopped ()), (u = i.isDefaultPrevented ())), a
        ? (h = document.createEvent ('HTMLEvents')).initEvent (s, l, !0)
        : (h = new CustomEvent (e, {bubbles: l, cancelable: !0})), void 0 !==
        n &&
        ...
        }), u && h.preventDefault (), c &&
        t.dispatchEvent (h), h.defaultPrevented &&
        void 0 !== i &&
        i.preventDefault (), h;
    },
  },
    W = (function () {
      ...
      return (t.prototype.dispose = function () {
        var t, e;
        (t = this._element), (e = this.constructor.DATA_KEY), A.delete (
          t,
          e
        ), (this._element = null);
    ...
    U = (function (t) {
      ...
      return (n.close = function (t) {
        ...
        t.parentNode && t.parentNode.removeChild (t), K.trigger (
          t,
          'closed.bs.alert'
        );
  ...
  var X = {
      ...
      return Object.keys (t.dataset)
        ...
        .forEach (function (n) {
          ...
          (i =
            ...
            i.slice (1, i.length)), (e[i] = z (t.dataset[n]));
        }), e;
    },
    ...
    q = function (t, e) {
      var n;
      return void 0 === e &&
        (e = document.documentElement), (n = []).concat.apply (
        n,
    ...
    J = (function (t) {
      function e (e, n) {
        ...
        return ((i =
          t.call (this, e) ||
          this)._items = null), (i._interval = null), (i._activeElement = null), (i._isPaused = !1), (i._isSliding = !1), (i.touchTimeout = null), (i.touchStartX = 0), (i.touchDeltaX = 0), (i._config = i._getConfig (
          n
          ...
          navigator.maxTouchPoints > 0), (i._pointerEvent = Boolean (
          window.PointerEvent
      ...
      return (n.next = function () {
        ...
        t || (this._isPaused = !0), Q (
          '.carousel-item-next, .carousel-item-prev',
          this._element
        ) && (p (this._element), this.cycle (!0)), clearInterval (
          this._interval
        ), (this._interval = null);
      }), (n.cycle = function (t) {
        ...
        t.prototype.dispose.call (this), K.off (
          this._element,
          '.bs.carousel'
        ), (this._items = null), (this._config = null), (this._interval = null), (this._isPaused = null), (this._isSliding = null), (this._activeElement = null), (this._indicatorsElement = null);
        ...
        var t = this,
          ...
          n = function (e) {
            !t._pointerEvent ||
              ('pen' !== e.pointerType && 'touch' !== e.pointerType) ||
              (t.touchDeltaX =
                e.clientX - t.touchStartX), t._handleSwipe (), 'hover' ===
              t._config.pause &&
        ...
        if (this._indicatorsElement) {
          ...
          for (
            ...
            if (
              ...
              n[i].classList.add ('active'), n[i].setAttribute (
                'aria-current',
                'true'
              );
              break;
        ...
        if (s && s.classList.contains ('active')) this._isSliding = !1;
          ...
          if (
            ((this._isSliding = !0), a &&
              ...
              s
            ), (this._activeElement = s), this._element.classList.contains (
              'slide'
            ))
          ) {
            s.classList.add (c), y (s), i.classList.add (l), s.classList.add (
              l
            );
            var h = f (i);
            K.one (i, 'transitionend', function () {
              s.classList.remove (
                l,
                c
              ), s.classList.add ('active'), i.classList.remove ('active', c, l), (n._isSliding = !1), setTimeout (function () {
            ...
            i.classList.remove ('active'), s.classList.add (
              'active'
            ), (this._isSliding = !1), K.trigger (
              this._element,
              'slid.bs.carousel',
              {relatedTarget: s, direction: u, from: o, to: r}
            );
          a && this.cycle ();
        }
        ...
        if (n && n.classList.contains ('carousel')) {
          ...
          o && (i.interval = !1), e.carouselInterface (n, i), o &&
            L (n, 'bs.carousel').to (o), t.preventDefault ();
        }
      }), o (e, null, [
        {
          key: 'Default',
  ...
  var tt = {toggle: !0, parent: ''},
    ...
    nt = (function (t) {
      function e (e, n) {
        ...
        ((i =
          t.call (this, e) ||
          this)._isTransitioning = !1), (i._config = i._getConfig (
          n
        )), (i._triggerArray = q (
        ...
        return (i._parent = i._config.parent ? i._getParent () : null), i
          ._config.parent ||
          i._addAriaAndCollapsedClass (i._element, i._triggerArray), i._config
          .toggle && i.toggle (), i;
      }
      r (e, t);
      var n = e.prototype;
      return (n.toggle = function () {
        ...
        if (
          ...
          if (!K.trigger (this._element, 'show.bs.collapse').defaultPrevented) {
            ...
            this._element.classList.remove (
              'collapse'
            ), this._element.classList.add ('collapsing'), (this._element.style[
              r
            ...
            K.one (this._element, 'transitionend', function () {
              t._element.classList.remove (
                'collapsing'
              ), t._element.classList.add ('collapse', 'show'), (t._element.style[r] = ''), t.setTransitioning (!1), K.trigger (t._element, 'shown.bs.collapse');
            }), m (this._element, l), (this._element.style[r] =
              this._element[a] + 'px');
          }
        }
      }), (n.hide = function () {
        ...
        if (
          ...
          (this._element.style[e] =
            this._element.getBoundingClientRect ()[e] + 'px'), y (
            this._element
          ...
          if (n > 0)
            for (var i = 0; i < n; i++) {
              ...
              s &&
                ...
                (o.classList.add ('collapsed'), o.setAttribute (
                  'aria-expanded',
                  !1
                ));
            }
          ...
          K.one (this._element, 'transitionend', function () {
            t.setTransitioning (
              !1
            ), t._element.classList.remove ('collapsing'), t._element.classList.add ('collapse'), K.trigger (t._element, 'hidden.bs.collapse');
          }), m (this._element, r);
        }
      }), (n.setTransitioning = function (t) {
        this._isTransitioning = t;
      }), (n.dispose = function () {
        t.prototype.dispose.call (
          this
        ), (this._config = null), (this._parent = null), (this._triggerArray = null), (this._isTransitioning = null);
      }), (n._getConfig = function (t) {
        return ((t = s ({}, tt, t)).toggle = Boolean (t.toggle)), _ (
          'collapse',
          t,
          et
        ), t;
        ...
        if (
          (!i &&
            ...
            'string' == typeof n &&
            /show|hide/.test (n) &&
            (o.toggle = !1), i || (i = new e (t, o)), 'string' == typeof n)
        ) {
          if (void 0 === i[n])
      ...
      q (n).forEach (function (t) {
        ...
        i
          ? (null === i._parent &&
              ...
              ((i._config.parent =
                e.parent), (i._parent = i._getParent ())), (n = 'toggle'))
          : (n = e), nt.collapseInterface (t, n);
      });
    }
  ), T ('collapse', nt);
  var it = new RegExp ('ArrowUp|ArrowDown|Escape'),
    ...
    dt = (function (e) {
      function i (t, n) {
        var i;
        return ((i =
          e.call (this, t) || this)._popper = null), (i._config = i._getConfig (
          n
        )), (i._menu = i._getMenuElement ()), (i._inNavbar = i._detectNavbar ()), i._addEventListeners (), i;
      }
      r (i, e);
      var a = i.prototype;
      return (a.toggle = function () {
        ...
        if (
          ...
          if (
            ...
            if (this._inNavbar)
              ...
              'parent' === this._config.reference
                ...
                : g (this._config.reference)
                    ? ((s = this._config.reference), void 0 !==
              ...
              (this._popper = t.createPopper (s, this._menu, r)), a &&
            ...
            'ontouchstart' in document.documentElement &&
              ...
              'show'
            ), this._element.classList.toggle ('show'), K.trigger (
              this._element,
              'shown.bs.dropdown',
              o
            );
        ...
        if (
          ...
          K.trigger (this._element, 'hide.bs.dropdown', t).defaultPrevented ||
            (this._popper &&
              this._popper.destroy (), this._menu.classList.toggle (
              'show'
            ), this._element.classList.toggle ('show'), X.removeDataAttribute (
              this._menu,
              'popper'
            ), K.trigger (this._element, 'hidden.bs.dropdown', t));
        }
      }), (a.dispose = function () {
        e.prototype.dispose.call (this), K.off (
          this._element,
          '.bs.dropdown'
        ...
        if (
          ((t = s (
            ...
            t
          )), _ ('dropdown', t, this.constructor.DefaultType), 'object' ==
            typeof t.reference &&
            !g (t.reference) &&
        ...
        return 'static' === this._config.display &&
          (t.modifiers = [{name: 'applyStyles', enabled: !1}]), s (
          {},
          t,
        ...
        if (
          (n || (n = new i (t, 'object' == typeof e ? e : null)), 'string' ==
            typeof e)
        ) {
          if (void 0 === n[e])
            ...
            if ((t && 'click' === t.type && (s.clickEvent = t), o)) {
              ...
              if (
                ...
                'ontouchstart' in document.documentElement &&
                  ...
                  'aria-expanded',
                  'false'
                ), o._popper && o._popper.destroy (), a.classList.remove (
                  'show'
                ), e[n].classList.remove ('show'), X.removeDataAttribute (
                  a,
                  'popper'
          ...
          if (n || ('ArrowUp' !== t.key && 'ArrowDown' !== t.key))
            if (n && 'Space' !== t.key) {
              ...
              if (o.length) {
                ...
                'ArrowUp' === t.key && s > 0 && s--, 'ArrowDown' === t.key &&
                  s < o.length - 1 &&
                  s++, o[(s = -1 === s ? 0 : s)].focus ();
              }
            } else i.clearMenus ();
            ...
            (this.matches ('[data-bs-toggle="dropdown"]')
              ? this
              : $ (this, '[data-bs-toggle="dropdown"]')[0]).click ();
        }
      }), o (i, null, [
        {
          key: 'Default',
  ...
  ), K.on (document, 'keydown.bs.dropdown.data-api', '.dropdown-menu', dt.dataApiKeydownHandler), K.on (document, 'click.bs.dropdown.data-api', dt.clearMenus), K.on (document, 'keyup.bs.dropdown.data-api', dt.clearMenus), K.on (
    document,
    'click.bs.dropdown.data-api',
    '[data-bs-toggle="dropdown"]',
    function (t) {
      t.preventDefault (), t.stopPropagation (), dt.dropdownInterface (
        this,
        'toggle'
      );
    }
  ), K.on (document, 'click.bs.dropdown.data-api', '.dropdown form', function (
    t
  ) {
  ...
  var ft = {backdrop: !0, keyboard: !0, focus: !0},
    ...
    gt = (function (t) {
      function e (e, n) {
        var i;
        return ((i = t.call (this, e) || this)._config = i._getConfig (
          n
        )), (i._dialog = Q (
          '.modal-dialog',
          e
        )), (i._backdrop = null), (i._isShown = !1), (i._isBodyOverflowing = !1), (i._ignoreBackdropClick = !1), (i._isTransitioning = !1), (i._scrollbarWidth = 0), i;
      }
      r (e, t);
      var n = e.prototype;
      return (n.toggle = function (t) {
        ...
        if (!this._isShown && !this._isTransitioning) {
          ...
          this._isShown ||
            n.defaultPrevented ||
            ((this._isShown = !0), this._checkScrollbar (), this._setScrollbar (), this._adjustDialog (), this._setEscapeEvent (), this._setResizeEvent (), K.on (
              this._element,
        ...
        var e = this;
        if (
          (t && t.preventDefault (), this._isShown &&
            !this._isTransitioning &&
          ...
          if (
            (n &&
              (this._isTransitioning = !0), this._setEscapeEvent (), this._setResizeEvent (), K.off (
              document,
              'focusin.bs.modal'
            ), this._element.classList.remove ('show'), K.off (
              this._element,
              'click.dismiss.bs.modal'
        ...
        [window, this._element, this._dialog].forEach (function (t) {
          ...
          document,
          'focusin.bs.modal'
        ), (this._config = null), (this._dialog = null), (this._backdrop = null), (this._isShown = null), (this._isBodyOverflowing = null), (this._ignoreBackdropClick = null), (this._isTransitioning = null), (this._scrollbarWidth = null);
        ...
        (this._element.parentNode &&
          ...
          'role',
          'dialog'
        ), (this._element.scrollTop = 0), i && (i.scrollTop = 0), n &&
          y (this._element), this._element.classList.add ('show'), this._config
          .focus && this._enforceFocus ();
        var o = function () {
          e._config.focus &&
            e._element.focus (), (e._isTransitioning = !1), K.trigger (
            e._element,
            'shown.bs.modal',
            {relatedTarget: t}
          );
        ...
        if (this._isShown && this._config.backdrop) {
          if (
            ((this._backdrop = document.createElement (
              ...
              this._backdrop.classList.add (n), document.body.appendChild (
              this._backdrop
              ...
              e._ignoreBackdropClick
                ...
                : t.target === t.currentTarget &&
                    ('static' === e._config.backdrop
                      ...
                      : e.hide ());
            }), n && y (this._backdrop), this._backdrop.classList.add (
              'show'
            ), !n)
          )
            return void t ();
        ...
        if (
          ...
          K.off (this._element, 'transitionend'), K.one (
            this._element,
            'transitionend',
            function () {
              t._element.classList.remove ('modal-static'), e ||
  ...
  K.on (
    ...
    function (t) {
      ...
      ('A' !== this.tagName && 'AREA' !== this.tagName) ||
        t.preventDefault (), K.one (n, 'show.bs.modal', function (t) {
        t.defaultPrevented ||
  ...
  var yt = new RegExp ('(^|\\s)bs-tooltip\\S+', 'g'),
    ...
    Lt = (function (e) {
      function i (t, i) {
        ...
        return ((o =
          e.call (this, t) ||
          this)._isEnabled = !0), (o._timeout = 0), (o._hoverState =
          ''), (o._activeTrigger = {}), (o._popper = null), (o.config = o._getConfig (
          i
      ...
      return (a.enable = function () {
        ...
        clearTimeout (this._timeout), K.off (
          this._element,
          ...
          this.tip.parentNode.removeChild (
            this.tip
          ), (this._isEnabled = null), (this._timeout = null), (this._hoverState = null), (this._activeTrigger = null), this
          ._popper &&
          this._popper.destroy (), (this._popper = null), (this.config = null), (this.tip = null), e.prototype.dispose.call (
          this
        );
      }), (a.show = function () {
        var e = this;
        ...
        if (this.isWithContent () && this._isEnabled) {
          ...
          if (!n.defaultPrevented && o) {
            ...
            s.setAttribute ('id', r), this._element.setAttribute (
              'aria-describedby',
              r
            ...
            var h,
              ...
              p = 'function' == typeof this.config.customClass
                ...
                : this.config.customClass;
            p &&
              (h = s.classList).add.apply (h, p.split (' ')), 'ontouchstart' in
        ...
        if (this._popper) {
            ...
            n = function () {
              'show' !== t._hoverState &&
                ...
                e.parentNode.removeChild (
                  e
                ), t._cleanTipClass (), t._element.removeAttribute (
                'aria-describedby'
              ), K.trigger (
                t._element,
          ...
          if (
            ...
            var i;
            if (
              (e.classList.remove ('show'), 'ontouchstart' in
                document.documentElement &&
                (i = []).concat
                  .apply (i, document.body.children)
                  .forEach (function (t) {
                    return K.off (t, 'mouseover', b);
                  }), (this._activeTrigger.click = !1), (this._activeTrigger.focus = !1), (this._activeTrigger.hover = !1), this.tip.classList.contains (
                'fade'
              ))
            ) {
              var o = f (e);
        ...
        var t = document.createElement ('div');
        return (t.innerHTML = this.config.template), (this.tip =
          t.children[0]), this.tip;
        ...
        if (null !== t)
          return 'object' == typeof e && g (e)
            ? (e.jquery && (e = e[0]), void (this.config.html
        ...
        (e = this._initializeOnDelegatedTarget (t, e)), t &&
          ...
          ] = !0), e.getTipElement ().classList.contains ('show') ||
          'show' === e._hoverState
          ? (e._hoverState = 'show')
        ...
        return Object.keys (e).forEach (function (t) {
          ...
          t.container.jquery &&
          (t.container = t.container[0]), 'number' ==
          typeof (t = s (
            {},
            this.constructor.Default,
            e,
          ...
          typeof t.content && (t.content = t.content.toString ()), _ (
          'tooltip',
          t,
          this.constructor.DefaultType
        ), t.sanitize &&
          (t.template = bt (t.template, t.allowList, t.sanitizeFn)), t;
  ...
  var Ct = new RegExp ('(^|\\s)bs-popover\\S+', 'g'),
    ...
    Ot = (function (t) {
      ...
      return (n.isWithContent = function () {
        ...
        'function' == typeof e &&
          (e = e.call (this._element)), this.setElementContent (
          Q ('.popover-body', t),
          e
        ), t.classList.remove ('fade', 'show');
        ...
        return this.each (function () {
          ...
          if (
            ...
            (n ||
              ((n = new e (this, i)), k (this, 'bs.popover', n)), 'string' ==
              typeof t)
          ) {
            if (void 0 === n[t])
              throw new TypeError ('No method named "' + t + '"');
  ...
  var It = {offset: 10, method: 'auto', target: ''},
    ...
    Pt = (function (t) {
      function e (e, n) {
        var i;
        return ((i = t.call (this, e) || this)._scrollElement = 'BODY' ===
          e.tagName
          ? window
          : e), (i._config = i._getConfig (n)), (i._selector =
          i._config.target +
          ' .nav-link, ' +
          i._config.target +
          ' .list-group-item, ' +
          i._config.target +
          ' .dropdown-item'), (i._offsets = []), (i._targets = []), (i._activeTarget = null), (i._scrollHeight = 0), K.on (
          i._scrollElement,
          'scroll.bs.scrollspy',
          function () {
            return i._process ();
      ...
      return (n.refresh = function () {
        ...
        (this._offsets = []), (this._targets = []), (this._scrollHeight = this._getScrollHeight ()), q (
          this._selector
        )
          .map (function (t) {
        ...
        t.prototype.dispose.call (this), K.off (
          this._scrollElement,
          '.bs.scrollspy'
        ), (this._scrollElement = null), (this._config = null), (this._selector = null), (this._offsets = null), (this._targets = null), (this._activeTarget = null), (this._scrollHeight = null);
      }), (n._getConfig = function (t) {
        if (
          'string' !=
        ...
        n.classList.contains ('dropdown-item')
          ...
          : (n.classList.add ('active'), (function (t, e) {
              for (
        ...
        return this.each (function () {
          ...
          if (
            (n || (n = new e (this, 'object' == typeof t && t)), 'string' ==
              typeof t)
          ) {
            if (void 0 === n[t])
              throw new TypeError ('No method named "' + t + '"');
  ...
  var xt = (function (t) {
    ...
    return (n.show = function () {
      ...
      if (e) {
        ...
        i && i.classList.remove ('active'), 'tab' === e.getAttribute ('role') &&
          e.setAttribute ('aria-selected', !1);
      }
      t.classList.add ('active'), 'tab' === t.getAttribute ('role') &&
        t.setAttribute ('aria-selected', !0), y (t), t.classList.contains (
        'fade'
    ...
    Mt = (function (t) {
      ...
      return (n.show = function () {
        ...
        if (!K.trigger (this._element, 'show.bs.toast').defaultPrevented) {
          ...
          var e = function () {
            t._element.classList.remove ('showing'), t._element.classList.add (
              'show'
            ), K.trigger (t._element, 'shown.bs.toast'), t._config.autohide &&
              (t._timeout = setTimeout (function () {
                t.hide ();
              }, t._config.delay));
          };
          if (
            (this._element.classList.remove ('hide'), y (
              this._element
        ...
        if (
          ...
          var e = function () {
            t._element.classList.add ('hide'), K.trigger (
              t._element,
              'hidden.bs.toast'
            );
          };
...
!(function () {
  ...
  function h (t, n) {
    if ('string' == typeof n) {
      var e = m ('div', {});
      E (e, {position: 'absolute', width: n}), w (t, e), (n =
        e.clientWidth), b (e);
    }
    return +n || 0;
  }
  ...
  var U = (function () {
    function t (t, e, i) {
      ...
      void 0 === e && (e = {}), void 0 === i &&
        ...
        ? t
        : document.querySelector (t)), j (
        this.root,
        'An invalid element/selector was given.'
      ), (this.Components = null), (this.Event = (function () {
        var t = [];
        function n (t) {
      ...
      })), (this.STATES = n), (this._o = a (
        N,
        e
      )), (this._i = 0), (this._c = i), (this._e = {}), (this._t = null);
    }
    ...
    return (u.mount = function (t, n) {
      ...
      void 0 === t && (t = this._e), void 0 === n &&
        ...
        R
      ), (this._e = t), (this._t = n), (this.Components = (function (t, n, e) {
        var i = {};
      ...
      return void 0 === n &&
        ...
        (this.State.is (G) && !n)) &&
        this.Components.Controller.go (t, !1), this;
    }), (u.is = function (t) {
      return t === this._o.type;
    }), (u.add = function (t, n) {
      return void 0 === n && (n = -1), this.Components.Elements.add (
        t,
        n,
      ...
      return this.emit ('refresh:before')
        .emit ('refresh')
        .emit ('resize'), this;
    ...
    Z = function (t, n) {
      ...
      var u = {
        ...
        init: function () {
          var t = this;
          !(function () {
            (u.slider = g (e, i.slider)), (u.track = p (
              e,
              '.' + i.track
            )), (u.list = g (u.track, i.list)), j (
              u.track && u.list,
            ...
            var n = d (i.autoplay);
            (u.bar = p (d (i.progress), '.' + i.bar)), (u.play = p (
              n,
              '.' + i.play
            )), (u.pause = p (n, '.' + i.pause)), (u.track.id =
              u.track.id || e.id + '-track'), (u.list.id =
              u.list.id || e.id + '-list');
          ...
          var o = (function (t, n, e, i) {
            var o = t.options.updateOnMove,
              ...
              a = {
                ...
                mount: function () {
                  var r = this;
                  this.isClone || (i.id = t.root.id + '-slide' + l (n + 1)), t
                    .on (s, function () {
                      return r.update ();
                    })
                    .on (Q, c)
      ...
      var e,
        ...
        o = {
          ...
          toIndex: function (n) {
            ...
            return i - o <= (s -= (this.pageLength * o - i) * $ (s / i)) &&
              s < i &&
              (s = i - o), s;
          },
          toPage: function (n) {
          ...
          trim: function (t) {
            return i ||
              (t = e.rewind ? this.rewind (t) : c (t, 0, this.edgeIndex)), t;
          },
          rewind: function (t) {
          ...
          get edgeIndex () {
            var n = t.length;
            return n
              ? r () || e.isNavigation || i ? n - 1 : n - e.perPage
              : 0;
          },
          get prevIndex () {
            var n = t.index - 1;
          ...
          get nextIndex () {
            var n = t.index + 1;
            return (i || e.rewind) && (n = this.rewind (n)), (t.index < n &&
              n <= this.edgeIndex) ||
              0 === n
              ? n
              : -1;
      ...
      var e,
        ...
        f = {
          ...
          mounted: function () {
            var n = this;
            s ||
              (this.jump (0), t.on ('mounted resize updated', function () {
                n.jump (t.index);
              }));
          },
          go: function (e, i, o) {
  ...
  var rt = function (t, n) {
        ...
        ? (function (t, n) {
            ...
            return {
              ...
              get height () {
                ...
                return j (t, '"height" or "heightRatio" is missing.'), h (
                  r,
                  t
                ) -
                  this.padding.top -
    ...
    function u () {
      a.init (), E (t.root, {maxWidth: f (t.options.width)}), r.each (function (
        t
      ) {
    ...
    ut = function (t, n) {
      ...
      return {
        ...
        mount: function () {
          t
            .on ('click', i, n.Elements.track, {capture: !0})
            .on ('drag', function () {
              e = !0;
            })
            .on ('dragged', function () {
    ...
    lt = function (t, n, e) {
      ...
      function c () {
        ...
        (i.disabled = s < 0 || !u), (o.disabled = a < 0 || !u), t.emit (
          e + ':updated',
          i,
          o,
          s,
      ...
      return {
        ...
        mount: function () {
          (i = u.arrows.prev), (o = u.arrows.next), (i && o) ||
            !t.options.arrows ||
            ...
            t
              ...
              .on ('mounted move updated refresh', c), (this.arrows = {
            prev: i,
            next: o,
          });
        },
    ...
    gt = function (t, n, e) {
      ...
      function s (n, o) {
        ...
        s && S (s.button, u), a && k (a.button, u), t.emit (
          e + ':updated',
          i,
          s,
          a
      ...
      return {
        ...
        mount: function () {
          t
            ...
            var n = i[t];
            n &&
              (h (n) || C (n, 'role', 'button'), C (n, bt, i.track.id), C (
                n,
                wt,
                e[t]
              ));
        ...
        return {
          ...
          mount: function () {
            (r = Object.keys (i)
              ...
              })), this.destroy (!0), addEventListener ('resize', o), (n =
              t.options), s ();
          },
          destroy: function (t) {
  ...
  var It = (function (t) {
    ...
    return (e = t), ((n = i).prototype = Object.create (
      e.prototype
    )), (n.prototype.constructor = n), (n.__proto__ = e), i;
  }) (U);
  window.Splide = It;
}) ();
...
!(function (t, n) {
  ...
  var n = 'undefined' != typeof window,
    ...
    G = function (t) {
      if (!R (t)) {
        var n = {};
        (n.src = t.getAttribute ('src')), (n.srcset = t.getAttribute (
          'srcset'
        )), (n.sizes = t.getAttribute ('sizes')), (t.llOriginalAttrs = n);
      }
    },
    T = function (t) {
      if (R (t)) {
    ...
    P = {
      ...
      VIDEO: function (t, n) {
        ...
        }) (t), N (t, 'poster', p (t, n.data_poster)), N (
          t,
          'src',
          p (t, n.data_src)
        ), t.load ();
      ...
      B (i) ||
        (function (t, n, e) {
          ...
          function (o) {
            !(function (t, n, e, i) {
              var o = y (n);
              K (n, e, i), L (n, e.class_loaded), h (n, u), I (
                e.callback_loaded,
                n,
                i
              ), o || $ (e, i);
          ...
          function (o) {
            !(function (t, n, e, i) {
              var o = y (n);
              K (n, e, i), L (n, e.class_error), h (n, f), I (
                e.callback_error,
                n,
                i
              ), o || $ (e, i);
    ...
    W = function (t, n, e) {
      !(function (t) {
        ...
        var i = p (t, n.data_bg),
          ...
          a = r && o ? o : i;
        a &&
          ((t.style.backgroundImage = 'url("'.concat (a, '")')), k (
            t
          ).setAttribute ('src', a), V (t, n, e));
      }) (t, n, e), (function (t, n, e) {
        var i = p (t, n.data_bg_multi),
          o = p (t, n.data_bg_multi_hidpi),
          a = r && o ? o : i;
        a &&
          ((t.style.backgroundImage = a), (function (t, n, e) {
            L (t, n.class_applied), h (t, d), n.unobserve_completed &&
              O (t, n), I (n.callback_applied, t, e);
          }) (t, n, e));
      }) (t, n, e);
    },
    X = function (t, n, e) {
    ...
    tt = function (t, n, e) {
      t.forEach (function (t) {
        return (function (t) {
          ...
          ? (function (t, n, e, i) {
              h (t, 'entered'), L (t, e.class_entered), w (
                t,
                e.class_exited
              ), (function (t, n, e) {
          ...
          : (function (t, n, e, i) {
              E (t) ||
                (L (t, e.class_exited), (function (t, n, e, i) {
                  e.cancel_on_exit &&
                    (function (t) {
                      return b (t) === l;
                    }) (t) &&
                    ...
                    }) (t), w (t, e.class_loading), x (i, -1), m (t), I (
                      e.callback_cancel,
                      t,
                      n,
                      i
  ...
  return (rt.prototype = {
            ...
            ? (function (t, n, e) {
                t.forEach (function (t) {
                  -1 !== Y.indexOf (t.tagName) &&
                    (t.setAttribute ('loading', 'lazy'), (function (t, n, e) {
                      Q (t, n, e), S (t, n), h (t, _);
                    }) (t, n, e));
                }), z (e, 0);
              }) (a, r, this)
    ...
    destroy: function () {
      this._observer && this._observer.disconnect (), et (
        this._settings
      ).forEach (function (t) {
        delete t.llOriginalAttrs;
      }), delete this._observer, delete this._settings, delete this
        .loadingCount, delete this.toLoadCount;
    },
    loadAll: function (t) {
...
!(function (e, t) {
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
        ? define ([], t)
        : 'object' == typeof exports ? (exports.Swup = t ()) : (e.Swup = t ());
}) (window, function () {
  return (function (e) {
    var t = {};
    function n (i) {
    ...
    return (n.m = e), (n.c = t), (n.d = function (e, t, i) {
      ...
      if (
        (n.r (i), Object.defineProperty (i, 'default', {
          enumerable: !0,
          value: e,
        }), 2 & t && 'string' != typeof e)
      )
    ...
    function (e, t, n) {
      ...
      (t.classify = i.default), (t.createHistoryRecord =
        r.default), (t.getDataFromHtml = o.default), (t.fetch =
        a.default), (t.transitionEnd = s.default), (t.getCurrentUrl =
        u.default), (t.markSwupElements = l.default), (t.Link = c.default);
    },
    function (e, t, n) {
      'use strict';
      Object.defineProperty (t, '__esModule', {
    ...
    function (e, t, n) {
      'use strict';
      var i, r = (i = n (3)) && i.__esModule ? i : {default: i};
      e.exports = r.default;
    },
    function (e, t, n) {
      'use strict';
      ...
      var w = (function () {
        function e (t) {
          ...
          (this._handlers = {
            ...
            transitionEnd: [],
            willReplaceContent: [],
          }), (this.scrollToElement = null), (this.preloadPromise = null), (this.options = r), (this.plugins = []), (this.transition = {}), (this.delegatedListeners = {}), (this.boundPopStateHandler = this.popStateHandler.bind (
            this
          )), (this.cache = new a.default ()), (this.cache.swup = this), (this.loadPage =
            s.default), (this.renderPage = u.default), (this.triggerEvent =
            l.default), (this.on = c.default), (this.off =
            d.default), (this.updateTransition =
            f.default), (this.getAnimationPromises =
            h.default), (this.getPageData =
            p.default), (this.log = function () {}), (this.use =
            m.use), (this.unuse = m.unuse), (this.findPlugin =
            m.findPlugin), this.enable ();
        }
        return r (e, [
          {
            key: 'enable',
            value: function () {
              ...
              if ('undefined' != typeof Promise) {
                ...
                (t.url = t.responseURL = (0, v.getCurrentUrl) ()), this.options
                  .cache && this.cache.cacheUrl (t), (0, v.markSwupElements) (
                  document.documentElement,
                  this.options.containers
          ...
          },
          {
            ...
            value: function () {
              var e = this;
              this.delegatedListeners.click.destroy (), window.removeEventListener (
                'popstate',
                this.boundPopStateHandler
              ), this.cache.empty (), this.options.plugins.forEach (function (
                t
              ) {
                e.unuse (t);
              }), (0, g.queryAll) ('[data-swup]').forEach (function (e) {
                e.removeAttribute ('data-swup');
              }), this.off (), this.triggerEvent (
                'disabled'
            ...
            value: function (e) {
              if (e.metaKey || e.ctrlKey || e.shiftKey || e.altKey)
                ...
                if (
                  ...
                  '' != t.getHash ()
                    ? (this.triggerEvent ('samePageWithHash', e), null !=
                        document.querySelector (t.getHash ())
            ...
            value: function (e) {
              if (!this.options.skipPopStateHandling (e)) {
                ...
                '' !== t.getHash ()
                  ...
                  : e.preventDefault (), this.triggerEvent (
                  'popState',
                  e
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t, n, r, o) {
        var a = function (e, t, n, r) {
          return function (n) {
            (n.delegateTarget = i (n.target, t)), n.delegateTarget &&
              r.call (e, n);
          };
        }.apply (this, arguments);
          ...
          return i (e, [
            {
              ...
              value: function (e) {
                e.url in this.pages == 0 &&
                  (this.pages[e.url] = e), (this.last = this.pages[
                  e.url
                ]), this.swup.log (
            ...
            },
            {
              key: 'empty',
              value: function () {
                (this.pages = {}), (this.last = null), this.swup.log (
                  'Cache cleared'
                );
              },
            },
    ...
    function (e, t, n) {
      ...
      t.default = function (e, t) {
        var n = this, o = [], a = void 0;
        this.triggerEvent ('transitionStart', t), null != e.customTransition
          ...
          : this.updateTransition (window.location.pathname, e.url), !t ||
          ...
          ? (function () {
              if (
                (n.triggerEvent (
                  ...
                  'is-leaving'
                ), document.documentElement.classList.add ('is-animating'), t &&
                  document.documentElement.classList.add (
                    'is-popstate'
                  ), document.documentElement.classList.add (
                  'to-' + (0, r.classify) (e.url)
                ), (o = n.getAnimationPromises ('out')), Promise.all (
                  o
                ).then (function () {
                ...
                var i;
                (i = null != n.scrollToElement
                  ? e.url + n.scrollToElement
                  : e.url), (0, r.createHistoryRecord) (i);
              }
            }) ()
          : this.triggerEvent ('animationSkipped'), this.cache.exists (e.url)
          ? ((a = new Promise (function (e) {
              e ();
            })), this.triggerEvent ('pageRetrievedFromCache'))
          : (a = this.preloadPromise && this.preloadPromise.route == e.url
              ? this.preloadPromise
              : new Promise (function (t, o) {
                  (0, r.fetch) (
                    i ({}, e, {headers: n.options.requestHeaders}),
                    function (i) {
                      if (500 === i.status)
                        return n.triggerEvent ('serverError'), void o (e.url);
                      var r = n.getPageData (i);
                      null != r
                        ? ((r.url = e.url), n.cache.cacheUrl (
                            r
                          ), n.triggerEvent ('pageLoaded'), t ())
                        : o (e.url);
                    }
                  );
                })), document
          .getElementById ('preloader')
          .classList.remove ('preloader-hide'), setTimeout (function () {
          Promise.all (o.concat ([a]))
            .then (function () {
              n.renderPage (
                n.cache.getPage (e.url),
                t
              ), (n.preloadPromise = null), setTimeout (function () {
                document
                  .getElementById ('preloader')
    ...
    function (e, t, n) {
      ...
      t.default = function (e) {
        ...
        }), o.open (r.method, r.url, !0), Object.keys (
          r.headers
        ).forEach (function (e) {
        ...
        r = (function () {
          function e (t) {
            !(function (e, t) {
              if (!(e instanceof t))
                throw new TypeError ('Cannot call a class as a function');
            }) (this, e), t instanceof Element || t instanceof SVGElement
              ? (this.link = t)
          ...
          return i (e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                return this.link.getAttribute ('xlink:href') &&
                  (e = this.link.getAttribute ('xlink:href')), '/' !== e[0] &&
                  (e = '/' + e), e;
              },
            },
            {
      ...
      t.default = function (e, t) {
        ...
        window.location.pathname !== o.getPath () &&
          (window.history.replaceState (
            ...
            document.title,
            o.getPath ()
          ), this.cache.cacheUrl (i ({}, e, {url: o.getPath ()}))), (t &&
          !this.options.animateHistoryBrowsing) ||
          document.documentElement.classList.add (
            'is-rendering'
        ...
        for (var a = 0; a < e.blocks.length; a++)
          document.body.querySelector ('[data-swup="' + a + '"]').outerHTML =
            e.blocks[a];
        if (
          ((document.title = e.title), this.triggerEvent (
            'contentReplaced',
            t
          ), this.triggerEvent ('pageView', t), this.options.cache ||
            this.cache.empty (), setTimeout (function () {
          ...
          Promise.all (s).then (function () {
            n.triggerEvent (
              'animationInDone'
            ), n.triggerEvent ('transitionEnd', t), document.documentElement.className.split (' ').forEach (function (e) {
    ...
    function (e, t, n) {
      ...
      t.default = function () {
        var e = [];
        return (0, i.queryAll) (
          this.options.animationSelector
        ).forEach (function (t) {
    ...
    function (e, t, n) {
      'use strict';
      Object.defineProperty (t, '__esModule', {value: !0}), (t.use = function (
        e
      ) {
        if (e.isSwupPlugin)
          return this.plugins.push (e), (e.swup = this), 'function' ==
            typeof e._beforeMount && e._beforeMount (), e.mount (), this
            .plugins;
        ...
        if (
          ...
          t.unmount (), 'function' == typeof t._afterUnmount &&
            t._afterUnmount ();
      ...
      var v = (function (e) {
        ...
        function t () {
          ...
          return (o = ((r = ((n = d (
            ...
            'PreloadPlugin'), (n.onContentReplaced = function () {
            n.swup.preloadPages ();
